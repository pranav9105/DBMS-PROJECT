    ...
    Walletize
        ...
        <div className="absolute bottom-4 left-4 right-4">
          <div className="bg-gradient-to-r from-emerald-50 to-green-50 rounded-xl p-4 border border-emerald-200/50">
            ...
            <button className="w-full mt-2 flex items-center justify-center space-x-2 px-3 py-2 rounded-lg text-sm text-slate-600 hover:bg-white hover:text-red-600 transition-all duration-300">
